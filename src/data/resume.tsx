...
export const DATA = {
  ...
  work: [
    ...
    },
    {
      ...
      description:
        "Consulted customers via telephone throughout every step of the process (B 2 C process). During the consultation provided individual solutions based on their hearing requirements. ",
    },
    {
